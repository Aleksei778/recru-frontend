        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-sm">
                    <h1 className="text-lg font-semibold text-gray-900 mb-2">{t('dashboard.interviews.token.invalid_link')}</h1>
            ...
            <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-6 p-4">
                <div className="max-w-2xl mx-auto flex items-center justify-between">
                    ...
                    {phase === 'active' && canFinish && (
                        ...
                        >
                            {t('dashboard.interviews.token.finish')}
                        </button>
                    )}
                </div>
            </div>
                    ...
                    {phase === 'ready' && info && (
                        <div className="text-center py-16">
                            ...
                            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                                {t('dashboard.interviews.token.hello') + }
                            </h2>
                        </div>
                    )}
                </div>
